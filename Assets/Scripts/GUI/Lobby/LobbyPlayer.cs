...
namespace MostDanger
{
    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        ...
        void SetupLocalPlayer()
        {
            ...
            if (playerName == "")
                CmdNameChanged("Player" + LobbyPlayerList.Instance.playerListContentTransform.childCount);
        ...
        {
            LobbyManager.Singleton.infoPanel.Display("Match Starting in " + countdown, "", null, false);

            if (countdown == 0)
                LobbyManager.Singleton.infoPanel.gameObject.SetActive(false);
        }
