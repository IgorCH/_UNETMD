...
/*
Tab - Open Inventory GUI

InventoryGUI.open(Inventory);
InventoryGUI.SetCurrentWeapon();

Inventory.CurrentWeapon.OnAttackDown();
Inventory.CurrentWeapon.OnAttackProcess();
Inventory.CurrentWeapon.OnAttackUp();
